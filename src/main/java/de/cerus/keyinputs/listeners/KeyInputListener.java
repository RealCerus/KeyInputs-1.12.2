...
public class KeyInputListener {
    ...
    private boolean isMoving() {
        ...
        if (input == null)
            input = minecraft.player.movementInput;
        return input.jump || input.backKeyDown || input.forwardKeyDown || input.leftKeyDown || input.rightKeyDown;
    }

    @SubscribeEvent
    public void onGuiOpen(GuiOpenEvent event) {
        guiOpen = (event.getGui() != null);
    }
}
